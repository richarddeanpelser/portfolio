...
SECRET_KEY = 'django-insecure-ca*b#v4gmih=ypua4o9(#7)$ojw)t3xxzokyekic7ptae%=uyi'
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'portfolio/static/')
STATIC_ROOT  = os.path.join(BASE_DIR, 'portfolio/staticfiles')
STATIC_URL = '/portfolio/static/'

STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'portfolio/static'),
    os.path.join(BASE_DIR, 'portfolio/static/images'),
 ]
